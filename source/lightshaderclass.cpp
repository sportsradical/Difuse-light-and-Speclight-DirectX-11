...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	WCHAR filenameVertexShader[1024] = L"../source/light.vs";
	WCHAR filenamePixelShader[1024] = L"../source/light.ps";

	result = InitializeShader(device, hwnd, filenameVertexShader, filenamePixelShader);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = D3DCompileFromFile(vsFilename, NULL, NULL, "LightPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, NULL, &pixelShaderBuffer, &errorMessage);
